...
describe GeojsonReportSerializer do
  ...
  it { expect(subject.serializable_hash[:properties]).to have_key(:name) }
  it { expect(subject.serializable_hash[:properties]).to have_key(:tracer_id) }
  it { expect(subject.serializable_hash[:properties]).to have_key(:title) }
  it { expect(subject.serializable_hash[:properties]).to have_key(:icon) }
